...
@singleton()
export default class ConfigurationService<T = Configuration> extends BaseService {
    private _config: T;
    ...
    public loadConfiguration(): T {
        ...
        applyObj.authMode = ["jwt", "session"].includes(loaded.AUTH_MODE) ? loaded.AUTH_MODE : "jwt";
