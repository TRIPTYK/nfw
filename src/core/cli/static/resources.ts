...
export default (entity: string): TemplateStructureInterface[] => {
    ...
    return [
        {template: "controller", path : "src/api/controllers", name : `${filePrefixName}.controller.ts`},
        {template: "repository", path : "src/api/repositories",name : `${filePrefixName}.repository.ts`},
        {template: "validation", path: "src/api/validations",name : `${filePrefixName}.validation.ts`},
