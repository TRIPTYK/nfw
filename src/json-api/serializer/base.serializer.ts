...
export abstract class BaseJsonApiSerializer<T> implements JsonApiSerializerInterface<T> {
    ...
    abstract serialize (data: T[] | T, extraData?: Record<string, unknown>): Promise<JSONAPIDocument>;
}
