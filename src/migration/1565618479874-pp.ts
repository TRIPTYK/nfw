...
export class pp1565618479874 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `user` ADD `role` enum ('admin', 'user', 'ghost') NOT NULL DEFAULT 'ghost'");
