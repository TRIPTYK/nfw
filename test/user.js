...
describe("User CRUD", function () {
  ...
  it('POST succeed as 201 on /api/v1/users', function (done) {
    agent
      .post('/api/v1/users')
  ...
  it('GET succeed as 200 on /api/v1/users/n', function (done) {
    agent
      .get('/api/v1/users/' + id)
      .set('Authorization', 'Bearer ' + token)
      .expect(200, done);
  ...
  it('PUT succeed as 200 on /api/v1/users/n', function (done) {
    agent
      .put('/api/v1/users/' + id)
      .set('Authorization', 'Bearer ' + token)
      .send({
  ...
  it('PATCH succeed as 200 on /api/v1/users/n', function (done) {
    agent
  ...
  it('DELETE succeed as 204 on /api/v1/users/n', function (done) {
    agent
