...
describe("Banane CRUD", function () {
  ...
  /**
   * POST a banane object to the API
   */
  ...
  /**
   * GET a banane object from the API
   */
  ...
  /**
   * PUT a banane object to the API
   */
  ...
  /**
   * PATCH a banane object to the API
   */
  ...
  /**
   * DELETE a banane object from the API
   */
