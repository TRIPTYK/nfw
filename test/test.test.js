...
describe("Test CRUD", function () {
  ...
  /**
   * GET a test object from the API
   */
  ...
  /**
   * PATCH a test object to the API
   */
  ...
  /**
   * DELETE a test object from the API
   */
