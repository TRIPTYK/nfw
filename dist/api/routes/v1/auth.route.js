...
router
    .route('/register')
    .post(Validate(user_validation_1.register), AuthController.register);
/**
...
router
    .route('/login')
    .post(Validate(user_validation_1.login), AuthController.login);
/**
...
router
    .route('/refresh-token')
    .post(Validate(user_validation_1.refresh), AuthController.refresh);
/**
...
router
    .route('/facebook')
    .post(Validate(user_validation_1.oAuth), auth_middleware_1.oAuth('facebook'), AuthController.oAuth);
/**
...
router
    .route('/google')
    .post(Validate(user_validation_1.oAuth), auth_middleware_1.oAuth('google'), AuthController.oAuth);
